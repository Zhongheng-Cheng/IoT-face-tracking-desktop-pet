...
PASSWORD = ""# Enter your WiFi name
#PASSWORD = "month3-hold-hut"
...
def camera_init():
    ...
    camera.framesize(camera.FRAME_96X96)  # Set the camera resolution
    ...
    camera.quality(60)  # quality: # 10-63 lower number means higher quality
